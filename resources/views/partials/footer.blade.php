            ...
            <div class="col-md-8 col-lg-4">
                <div class="ftco-footer-widget mb-5">
                    ...
                    <div class="block-23 mb-3">
                        <ul>
                            <li><span class="icon icon-map-marker"></span><span class="text">Carrer Almirante Antequera, 9. 03130. Santa Pola (Alicante)</span></li>
                            <li><a href="#"><span class="icon icon-phone"></span><span class="text">+34 123 45 67 89</span></a></li>
                            <li><a href="#"><span class="icon icon-envelope"></span><span class="text">info@eternorecuerdo.com</span></a></li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="col-md-8 col-lg-4">
                <div class="ftco-footer-widget mb-5 ml-md-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="{{url('servicios')}}"><span class="ion-ios-arrow-round-forward mr-2"></span>Servicios</a></li>
                        <li><a href="{{url('colaboradores')}}"><span class="ion-ios-arrow-round-forward mr-2"></span>Colaboradores</a></li>
